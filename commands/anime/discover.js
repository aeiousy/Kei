...
module.exports = {
  ...
  run: async ( client, message, [category = '']) => {
    ...
    .setColor('RED')
    .setFooter(`Discover | \©️${new Date().getFullYear()} Kei`);
    ...
    if (res && res.errors.length){
      return message.channel.send(
        ...
        .setDescription([
          ...
          'or [join](https://support.Kei-san.ml/) Kei\'s dev server instead.'
        ].join(' '))
      );
    };
    ...
    const discoveryPages = new Paginate(
      ...
      .setFooter(`Discover ${topic}\u2000|\u2000\©️${new Date().getFullYear()} Kei`)
      .addFields([
        {
          name: '\u200b',
