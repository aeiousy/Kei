...
module.exports = {
  ...
  group: 'anime',
  description: 'Returns reKeining time for the next episode of given anime. Returns this day\'s schedule, if no anime is specified',
  ...
  run: async ( client, message, args ) => {
    ...
    .setFooter(`Airdate Query with AL | \©️${new Date().getFullYear()} Kei`);
