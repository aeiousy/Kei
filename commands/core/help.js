  ...
  run: (client, message, [query] ) => {
    ...
    if (!query){
      return message.channel.send(
        new MessageEmbed()
        .setColor('GREY')
        .setTitle('Hello! I\'m Kei and I am a bot based around anime')
        .setAuthor(client.user.username, client.user.displayAvatarURL())
        .setFooter(`Help | \©️${new Date().getFullYear()} Kei`)
        .setDescription([
          '<a:Kei_stare1:783382661195759616><a:Kei_stare2:783383003216216123><a:Kei_stare3:783383266760851526><a:Kei_stare4:783383656013627484>',
          '<a:Kei_stare1:783382661195759616><a:Kei_stare2:783383003216216123><a:Kei_stare3:783383266760851526><a:Kei_stare4:783383656013627484>',
          '<a:Kei_stare1:783382661195759616><a:Kei_stare2:783383003216216123><a:Kei_stare3:783383266760851526><a:Kei_stare4:783383656013627484>\n',
          '\n\u2000•\u2000\u2000[Who is **Kei**?](https://myanimelist.net/character/118739/)\n',
          '\u2000•\u2000\u2000[From what anime is ***Kei***\u2000from?](https://myanimelist.net/anime/37450/)\n',
          '\u2000•\u2000\u2000[Is Kei a **Top-tier** waifu?](https://www.seekpng.com/png/detail/495-4955052_why-do-people-say-yes-big-yes.png)'
        ].join(' '))
        .addFields({
          name: 'What can I Do?',
          value: [
