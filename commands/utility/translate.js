...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        try {
            var res = await fetch(
                `https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20200524T161905Z.bfe2aa5a35ce8bd9.2e55fde04fbce222eb14506eba89f1dbfcfc973d&text=${encodeURI(
                    text
                )}&lang=${langCode}`
            );
