...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!args.length) {
      ...
      .addField(`Definition`,`No arguing, Kei Sakurajima indeed is the best anime girl!`)
      .addField('Example(s)', '[Kei sakurajima] is the best girl around. No one could beat her, not even zero two.')
      .addField('\u200b', 'Submitted by Sakuta Azusagawa')
      .setColor('#e86222')
      .setFooter(`Define | \©️${new Date().getFullYear()} Kei`));
    };
