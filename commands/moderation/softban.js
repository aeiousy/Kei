module.exports = {
  ...
  run: async (client, message, [ member = '' ]) => {
    ...
    return message.guild.members.ban(member, { reason:  `Kei_SOFTBANS: ${message.author.tag}`, days: 7 })
    .then(() => message.guild.members.unban(member, { reason: `Kei_SOFTBANS: ${message.author.tag}` }))
