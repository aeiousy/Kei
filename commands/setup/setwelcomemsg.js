  ...
  run: (client, message, [stats = '', ...args]) => guilds.findById(message.guild.id, (err, doc) => {
    ...
    if (!stats || !stats.match(/default|(msg|embed)=true|(msg|embed)=set|test/)){
      return message.channel.send(
        new MessageEmbed()
        .setColor('RED')
        .setFooter(`Member Greeter | \©️${new Date().getFullYear()} Kei`)
        .setDescription([
          '<:cancel:767062250279927818>\u2000\u2000|\u2000\u2000',
          'Please include the option parameter\n\n',
          '[Learn more](https://Kei-san.ml/docs/Getting%20Started/custom_welcome_message) ',
          'on how to configure Kei\'s Member Greeter feature.'
        ].join(''))
      )
    };
      ...
      .then(() => {
        ...
        return message.channel.send(
          ...
          .setDescription([
            ...
            'Incoming members will now be announced by Kei\'s default announce message.\n',
              ...
              .then(() => {
                ...
                return message.channel.send(
                  ...
                  .setDescription([
                    ...
                    '[Learn More](https://Kei-san.ml/docs/Getting%20Started/custom_welcome_message) on how to configure Kei\'s Member Greeter feature.'
                  ].join(' '))
                );
              }).catch(() => sendError(message));
            };
