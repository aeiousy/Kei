...
module.exports = {
  ...
  adminOnly: true,
  group: 'setup',
  description: 'Set up the goodbye message. Supports Embeds! [Learn how to set up your Leaving Member Announcer](https://Kei-san.ml/)',
  ...
  run: (client, message, [stats = '', ...args]) => guilds.findById(message.guild.id, (err, doc) => {
    ...
    if (!stats || !stats.match(/default|(msg|embed)=true|(msg|embed)=set|test/)){
      return message.channel.send(
        new MessageEmbed()
        .setColor('RED')
        .setFooter(`Leaving Member Announcer | \©️${new Date().getFullYear()} Kei`)
        .setDescription([
          '<:cancel:767062250279927818>\u2000\u2000|\u2000\u2000',
          'Please include the option parameter\n\n',
          '[Learn more](https://Kei-san.ml/docs/Getting%20Started/custom_leave_message) ',
          'on how to configure Kei\'s Leaving Member Announcer feature.'
        ].join(''))
      )
    };
      ...
      .then(() => {
        ...
        return message.channel.send(
          ...
          .setDescription([
            ...
            'Outgoing members will now be announced by Kei\'s default announce message.\n',
              ...
              .then(() => {
                ...
                return message.channel.send(
                  ...
                  .setDescription([
                    ...
                    '[Learn More](https://Kei-san.ml/docs/Getting%20Started/custom_leave_message) on how to configure Kei\'s Leaving Member Announcer feature.'
                  ].join(' '))
                );
              }).catch(() => sendError(message));
            };
